...
mod tests {
    ...
    use netgauze_udp_notif_pkt::{MediaType, UdpNotifHeader, UdpNotifPacket};
    use std::io::Cursor;
    ...
    fn generate_udp_notif_data(payload: Bytes) -> (UdpNotifPacket, BytesMut) {
        ...
        let hdr = UdpNotifHeader::new(1, false, MediaType::YangDataJson, 1, 1, HashMap::new());
        let pkt = UdpNotifPacket::new(hdr, payload);
